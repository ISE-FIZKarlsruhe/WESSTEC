...
public class WikiPreprocessor extends DocumentPreprocessor {
	...
	public static void main(String[] args) throws Exception {
		...
		WikiPreprocessor preprocessor = new WikiPreprocessor();
		PreprocessedDocument document = preprocessor.preprocess(text);
		System.out.println(document.getPreprocessedText());
		br.close();
	}
