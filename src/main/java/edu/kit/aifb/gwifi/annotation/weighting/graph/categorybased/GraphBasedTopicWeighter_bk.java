...
public abstract class GraphBasedTopicWeighter_bk extends TopicWeighter {
...
//	private String catenamefile="/home/ls3data/users/lzh/congliu/categories_aida.txt";
	...
	private static Logger logger = Logger.getLogger(GraphBasedTopicWeighter_bk.class);

	public GraphBasedTopicWeighter_bk(Wikipedia wikipedia, DisambiguationUtil disambiguationUtil) {
	...
	public Map<String, Double> getAidaCatePro(double m) {
		...
		String cate = getCategoriesByTitle(GraphBasedTopicWeighter_bk.getTitleOfaidatext());
		if (cate == null) {
