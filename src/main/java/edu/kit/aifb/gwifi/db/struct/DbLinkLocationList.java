...
public class DbLinkLocationList extends org.apache.hadoop.record.Record {
  ...
  static {
    ...
    _rio_recTypeInfo.addField("LinkLocations", new org.apache.hadoop.record.meta.VectorTypeID(new org.apache.hadoop.record.meta.StructTypeID(edu.kit.aifb.gwifi.db.struct.DbLinkLocation.getTypeInfo())));
  }
  
  private java.util.ArrayList<edu.kit.aifb.gwifi.db.struct.DbLinkLocation> LinkLocations;
  public DbLinkLocationList() { }
  public DbLinkLocationList(
    final java.util.ArrayList<edu.kit.aifb.gwifi.db.struct.DbLinkLocation> LinkLocations) {
  ...
  public static void setTypeFilter(org.apache.hadoop.record.meta.RecordTypeInfo rti) {
    ...
    edu.kit.aifb.gwifi.db.struct.DbLinkLocation.setTypeFilter(rti.getNestedStructTypeInfo("DbLinkLocation"));
  }
  ...
  public java.util.ArrayList<edu.kit.aifb.gwifi.db.struct.DbLinkLocation> getLinkLocations() {
    return LinkLocations;
  }
  public void setLinkLocations(final java.util.ArrayList<edu.kit.aifb.gwifi.db.struct.DbLinkLocation> LinkLocations) {
    this.LinkLocations=LinkLocations;
  }
  ...
  throws java.io.IOException {
    _rio_a.startRecord(this,_rio_tag);
    {
      ...
      for(int _rio_vidx1 = 0; _rio_vidx1<_rio_len1; _rio_vidx1++) {
        edu.kit.aifb.gwifi.db.struct.DbLinkLocation _rio_e1 = LinkLocations.get(_rio_vidx1);
  ...
  throws java.io.IOException {
    _rio_a.startRecord(_rio_tag);
    {
      ...
      LinkLocations=new java.util.ArrayList<edu.kit.aifb.gwifi.db.struct.DbLinkLocation>();
      for (; !_rio_vidx1.done(); _rio_vidx1.incr()) {
        edu.kit.aifb.gwifi.db.struct.DbLinkLocation _rio_e1;
        _rio_e1= new edu.kit.aifb.gwifi.db.struct.DbLinkLocation();
  ...
  public int compareTo (final Object _rio_peer_) throws ClassCastException {
    ...
    int _rio_ret = 0;
    {
      ...
      for(int _rio_vidx1 = 0; _rio_vidx1<_rio_len11 && _rio_vidx1<_rio_len21; _rio_vidx1++) {
        edu.kit.aifb.gwifi.db.struct.DbLinkLocation _rio_e11 = LinkLocations.get(_rio_vidx1);
        edu.kit.aifb.gwifi.db.struct.DbLinkLocation _rio_e21 = _rio_peer.LinkLocations.get(_rio_vidx1);
  ...
  public Object clone() throws CloneNotSupportedException {
    ...
    _rio_other.LinkLocations = (java.util.ArrayList<edu.kit.aifb.gwifi.db.struct.DbLinkLocation>) this.LinkLocations.clone();
    return _rio_other;
  }
  public int hashCode() {
    int _rio_result = 17;
      ...
      try {
        int os = s;
        {
          ...
          for (int vidx1 = 0; vidx1 < vi1; vidx1++){
            int r = edu.kit.aifb.gwifi.db.struct.DbLinkLocation.Comparator.slurpRaw(b,s,l);
            s+=r; l-=r;
          }
        }
        return (os - s);
      ...
      try {
        int os1 = s1;
        {
          ...
          for (int vidx1 = 0; vidx1 < vi11 && vidx1 < vi21; vidx1++){
            int r1 = edu.kit.aifb.gwifi.db.struct.DbLinkLocation.Comparator.compareRaw(b1,s1,l1,b2,s2,l2);
            if (r1 <= 0) { return r1; }
