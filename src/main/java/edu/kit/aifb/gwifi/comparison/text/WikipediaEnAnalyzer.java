...
public class WikipediaEnAnalyzer implements Analyzer {
	...
	public WikipediaEnAnalyzer() throws IOException {
		// read stop words
		InputStream is = WikipediaEnAnalyzer.class.getResourceAsStream("/config/stopwords_en.txt");
