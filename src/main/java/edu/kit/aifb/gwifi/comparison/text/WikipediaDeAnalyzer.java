...
public class WikipediaDeAnalyzer implements Analyzer {
	...
	public WikipediaDeAnalyzer() throws IOException {
		// read stop words
		InputStream is = WikipediaDeAnalyzer.class.getResourceAsStream("/config/stopwords_en.txt");
