...
public class ExtractCategory {
	...
	public ExtractCategory(String filename) throws Exception {
		mongoInit();
	...
	private void mongoInit() {
		...
		mycollection = db.getCollection("aidaConell");
	}
	...
	public static void main(String[] args) throws Exception {
		...
		ExtractCategory c = new ExtractCategory("res/aidaConell.txt");
