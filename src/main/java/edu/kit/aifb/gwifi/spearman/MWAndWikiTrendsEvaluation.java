...
public class MWAndWikiTrendsEvaluation {

	private Wikipedia wikipedia;
	private static WikipediaTrendsComparer wt_comparer;
	private static ArticleComparer mw_comparer;
//	private static final String ConfigPath = "/home/ls3data/users/lzh/zj/configs/wikipedia-template-en.xml";
	...
	public static void main(String[] args) throws Exception {
		...
		MWAndWikiTrendsEvaluation se = new MWAndWikiTrendsEvaluation(ConfigPath);
...
//							sim = comparer.calc(seedArticle.getTitle(), targetArticle.getTitle(), WikiTrendsPath);
							...
							sim = wt_comparer.calc(file, "2014/01/01", "2015/01/01");
						}	
						simMap.put(str, sim);
					}
...
//				sim = comparer.calc(seedArticle.getTitle(), targetArticle.getTitle(), WikiTrendsPath);
	...
	public MWAndWikiTrendsEvaluation(String config) throws Exception {
		File databaseDirectory = new File(config);
		wikipedia = new Wikipedia(databaseDirectory, false);
		wt_comparer = new WikipediaTrendsComparer();
	}
