...
public class ArticleComparerEvaluation {
	...
	public static void main(String[] args) throws Exception {
		...
		ArticleComparerEvaluation se = new ArticleComparerEvaluation(ConfigPath);
				...
				if (count > 1) {
					...
					for (int i = 0; i < entityNames.size(); i++) {
						...
						if (targetArticle != null)
							sim = comparer.getRelatedness(seedArticle, targetArticle);
						simMap.put(str, sim);
					}
	...
	public ArticleComparerEvaluation(String config) throws Exception {
