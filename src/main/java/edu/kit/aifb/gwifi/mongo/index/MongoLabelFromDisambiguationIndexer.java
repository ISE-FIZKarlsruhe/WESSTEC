 ...
 * 
 */
public class MongoLabelFromDisambiguationIndexer {
	...
	public MongoLabelFromDisambiguationIndexer(String dbDir, String langLabel) throws Exception {
	...
	public static void main(String[] args) {
		...
		try {
			...
			MongoLabelFromDisambiguationIndexer indexer = new MongoLabelFromDisambiguationIndexer(args[1], args[2]);
			indexer.insertLabel();
		} catch (Exception e) {
			e.printStackTrace();
		}
