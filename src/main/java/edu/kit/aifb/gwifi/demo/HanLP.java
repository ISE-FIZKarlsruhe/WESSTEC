...
public class HanLP
{
    ...
    public static void main(String[] args) {
    	System.out.println(HanLP.convertToSimplifiedChinese("「以後等妳當上皇后，就能買士多啤梨慶祝了」"));
 	    System.out.println(HanLP.convertToSimplifiedChinese("“以后等你当上皇后，就能买草莓庆祝了”"));
    	...
    	System.out.println(HanLP.convertToPinyinString("「以後等妳當上皇后，就能買士多啤梨慶祝了」", "-", false));
 	    System.out.println(HanLP.convertToPinyinString("“以后等你当上皇后，就能买草莓庆祝了”", "-", false));
    }
}